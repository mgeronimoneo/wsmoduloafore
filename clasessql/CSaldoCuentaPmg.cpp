#include "CSaldoCuentaPmg.hpp"
CSaldoCuentaPmg::CSaldoCuentaPmg(C_ODBC *odbc_ext, const char *select) : CRecordSet(odbc_ext)
{
    odbc = odbc_ext;
    nCols=4;
    odbcRet=TRUE;
...
CSaldoCuentaPmg::~CSaldoCuentaPmg()
{
}

void CSaldoCuentaPmg::activarCols()
{
    int i;
    for (i=0; i<nCols; i++)
    {

...
SOAP_FMAC5 int SOAP_FMAC6 ns2__consultarAfiliado(struct soap*, ns2__ParamConsultarAfiliado *in, struct ns2__consultarAfiliadoResponse &_param_1)
{
	...
	if(shRet == OK__)
	{
		...
		memcpy(_param_1.out->datosAfiliado->cApellidoPaterno, stDatosAfil->cApellidoPaterno, sizeof(stDatosAfil->cApellidoPaterno));
		memcpy(_param_1.out->datosAfiliado->cApellidoMaterno, stDatosAfil->cApellidoMaterno, sizeof(stDatosAfil->cApellidoMaterno));
		memcpy(_param_1.out->datosAfiliado->cNombre, stDatosAfil->cNombre, sizeof(stDatosAfil->cNombre));
		memcpy(_param_1.out->datosAfiliado->cCurp, stDatosAfil->cCurp, sizeof(stDatosAfil->cCurp));
		memcpy(_param_1.out->datosAfiliado->cNss, stDatosAfil->cNss, sizeof(stDatosAfil->cNss));
		memcpy(_param_1.out->datosAfiliado->cEntidadNacimiento, stDatosAfil->cEntidadNacimiento, sizeof(stDatosAfil->cEntidadNacimiento));
		memcpy(_param_1.out->datosAfiliado->cFechaNacimiento, stDatosAfil->cFechaNacimiento, sizeof(stDatosAfil->cFechaNacimiento));
		memcpy(_param_1.out->datosAfiliado->cFechaServicio, stDatosAfil->cFechaServicio, sizeof(stDatosAfil->cFechaServicio));
